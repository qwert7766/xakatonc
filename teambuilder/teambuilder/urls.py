...
urlpatterns = [
    ...
    path('constructor/', create_ideal_profile, name='create_ideal_profile'),
    path('recommendation/<int:profile_id>/', show_recommendation, name='show_recommendation'),
    path('recommendation/<int:profile_id>/hire/<int:employee_id>/', hire_employee, name='hire_employee'),
    path('recommendation/<int:profile_id>/reject/<int:employee_id>/', reject_employee, name='reject_employee'),
    path('recommendation/<int:profile_id>/postpone/<int:employee_id>/', postpone_employee, name='postpone_employee'),
    path('recommendation/<int:profile_id>/remove-pending/<int:employee_id>/', remove_from_pending, name='remove_from_pending'),
