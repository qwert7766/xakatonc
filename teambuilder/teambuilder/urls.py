...
from recommendations.views import create_ideal_profile, show_recommendation, save_recommendation_status
...
urlpatterns = [
    ...
    path('recommendation/<int:profile_id>/save/<int:employee_id>/', 
         save_recommendation_status, name='save_recommendation_status'),
